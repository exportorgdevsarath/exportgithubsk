...
import { EtableApiConstants } from './etable.api-constants';
...
public baseService = inject(BaseService);
	  ...
	  getProtoTypingData(): Observable<any> {
	      const subject:Observable<EtableBase> = new Observable(observer => {
	        const data =  require('base/assets/sample-data/etable.json');
	        observer.next(data as EtableBase);
	      });
	      return subject;
	  }
	    ...
	    let data: any = {};
	    const subject: Observable<EtableBase> = new Observable(observer => {
	      const response = require('base/assets/sample-data/etable.json');
	      response.map((o: any) => {
    ...
    create(...args: any):Observable<any>{
        const serviceOpts = EtableApiConstants.create;
        const params= args[0];
    ...
    delete(...args: any):Observable<any>{
        const serviceOpts = EtableApiConstants.delete;
        const params= args[0];
    ...
    autoSuggestService(...args: any):Observable<any>{
        const serviceOpts = EtableApiConstants.autoSuggestService;
        const params= args[0];
    ...
    getDatatableData(...args: any):Observable<any>{
        const serviceOpts = EtableApiConstants.getDatatableData;
        const params= args[0];
    ...
    getById(...args: any):Observable<any>{
        const serviceOpts = EtableApiConstants.getById;
        const params= args[0];
    ...
    update(...args: any):Observable<any>{
        const serviceOpts = EtableApiConstants.update;
        const params= args[0];
